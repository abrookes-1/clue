...
public class CTest_FileInitTests_Custom {
	...
	public void FourDoorDirections() {
		BoardCell room = board.getCellAt(2, 6);
		...
		room = board.getCellAt(10, 21);
		assertFalse(room.isDoorway());	
		// Test that walkways are not doors
		BoardCell cell = board.getCellAt(12, 14);
	...
	public void testRoomInitials() {
		...
		assertEquals('D', board.getCellAt(2, 11).getInitial());
		assertEquals('K', board.getCellAt(3, 21).getInitial());
